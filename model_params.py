...
class NetParams():
    def __init__(self):
        ...
        self.params_tran = dict(
            file_class="nn1",
            max_seq_length= 50,
            hidden_size= 32,  #modify,original 40
            num_hidden_layers= 5,
            num_attention_heads= 4,  #in table VI h--head
            ffn_dim= 120,
            dropout= 0.2,
            lr1= 0.00000003,
            batch_size= 256,  #modify, original 128
        )
        # Parameters for pop
...
#         self.params_tran = dict(
#             file_class="nn1",
#             max_len=50,    # 60 for ml-1m, 50 for lastfm_small
#             emb_dim=30,
#             n_layers=6,
#             n_heads=6,
#             ffn_dim=120,
