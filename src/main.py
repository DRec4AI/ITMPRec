...
def main():
    ...
    if args.data_name == 'lastfm':
        # item_emb_path = f"E:/projects/GraphAU-main/datasets/{args.data_name}/item_emb5-v2.pt"
        item_emb_path = f"E:/projects/GraphAU-main/datasets/{args.data_name}/item_emb-v2-64.pt"
    elif args.data_name == 'ml100k':
        # item_emb_path = f"E:/projects/GraphAU-main/datasets/{args.data_name}/item_emb-au-1.0-0731-1016.pt"
        item_emb_path = f"E:/projects/GraphAU-main/datasets/{args.data_name}/item_emb-v2-64.pt"
    elif args.data_name == "douban_movie":
        item_emb_path = f"E:/projects/GraphAU-main/datasets/{args.data_name}/item_emb-au-10-0802-1200.pt"
    else:
        item_emb_path = f"E:/projects/GraphAU-main/datasets/{args.data_name}/item_emb.pt"
    ...
    if args.do_eval:
        ...
        early_stopping = EarlyStopping(args.checkpoint_path, patience=20, verbose=True)  #modify, original patience is 40
